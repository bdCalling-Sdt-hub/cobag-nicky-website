    ...
    return (
        <div className='bg-primary text-white '>
            <div className='w-[90%] mx-auto '>
                <div className='grid xl:grid-cols-6 md:grid-cols-3 sm:grid grid-cols-1 gap-14  justify-start  py-10'>
                    <div>
                        <img src="/Images/LogoWhite.png" alt="" />
                        <p className='text-justify mt-5 leading-7 text-gray-300'>CoBag connects individuals: some resell their unused kilos, while others take advantage of it to send, receive, or transport at a lower cost and with complete simplicity, benefiting from delivery in just a few hours worldwide.</p>
                    </div>
                    <div>
                        <h2 className='text-xl mt-6 font-semibold'>Contract </h2>

                        <ul className='mt-6'>
                            <li className='flex gap-3 text-gray-300'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 0 25 24" fill="none">
                            ...
                            <Link href={'/faq'} className='flex gap-3 mt-3'>
                                ...
                                <span className=' hover:border-b-2 hover:border-white text-gray-300'>FAQ</span>
                            </Link>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl mt-6 font-semibold">Quick links</h3>
                        <ul className='mt-6'>
                            <Link href={'/usecase'} className='my-5 block text-gray-300 hover:underline'>How to use CoBag?</Link>
                            <Link href={'/faq'} className='my-5 block text-gray-300 hover:underline'>FAQ</Link>
                            <Link href={'/about'} className='my-5 block text-gray-300 hover:underline'>About</Link>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl mt-6 font-semibold">Traveler</h3>
                        <ul className='mt-6'>
                            <Link href={'/'} className='my-5 block text-gray-300'>Propose a route</Link>
                            <Link href={'/'} className='my-5 block text-gray-300'>Traveler rates</Link>
                            <Link href={'/faq'} className='my-5 block text-gray-300'>Traveler FAQ</Link>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl mt-6 font-semibold">Shippers</h3>
                        <ul className='mt-6'>
                            <li className='my-5 text-gray-300'>Send a package</li>
                            <li className='my-5 text-gray-300'>International purchases</li>
                            <li className='my-5 text-gray-300'>Shipper rates</li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl mt-6 font-semibold">Courier</h3>
                        <ul className='mt-6'>
                            <li className='my-5 text-gray-300'>Offer a route</li>
                            <li className='my-5 text-gray-300'>Courier rates</li>
                            <li className='my-5 text-gray-300'>Search Courier</li>
                        </ul>
                    </div>
                </div>
                <hr className='' />
                <div className='flex justify-center items-center text-gray-200 gap-5 flex-wrap py-10'>
