...
const DoseItWork = () => {
    ...
    return (
        <div className='bg-[#f8f8fb] py-20 '>
            <h2 data-aos="fade-up" data-aos-duration="500" className='text-center md:text-5xl text-3xl text-primary font-semibold'>{t('Howdoesitwork1001')}</h2>

            <div className='mt-10 md:w-[70%] w-[90%] mx-auto grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10'>
                <div data-aos="fade-up" data-aos-duration="300" className='bg-white shadow-md relative p-10 flex flex-col items-center rounded-xl text-center'>
                ...
                <div data-aos="fade-up" data-aos-duration="500" className='bg-white shadow-md relative p-10 flex flex-col items-center rounded-xl text-center'>
                ...
                <div data-aos="fade-up" data-aos-duration="800" className='bg-white shadow-md relative p-10 flex flex-col items-center rounded-xl text-center'>
            ...
            <Link href={'/ourconcept'} className='flex items-center justify-center mt-20 '>
                <button className='bg-primary hover:bg-[#0d2c98] hover:scale-[1.1] duration-300 text-white py-3 px-8 rounded-xl flex items-center gap-2 justify-center'> <FaRegCircleQuestion className='text-xl' />{t('LearnMore1008')}</button>
            </Link>
